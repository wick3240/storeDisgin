...
CREATE TABLE `product_info` (
  ...
  `cid` VARCHAR(64)  NULL COMMENT '分类id',
  ...
  `sort` INT  NULL COMMENT '用于轮播图的排序',
  `pub_code` VARCHAR(64)  NULL COMMENT '产品单号',
...
CREATE TABLE `product_category` (
  ...
  `name` VARCHAR(255)  NULL COMMENT '产品分类名字',
  `created_date` DATE NOT NULL COMMENT '创建时间',
  `update_date` DATE NOT NULL COMMENT '更新日期',
  `is_deleted` INT NOT NULL COMMENT '是否删除',
...
CREATE TABLE `publish_approve` (
  ...
  `approve_status` INT  NULL COMMENT '审批状态',
  `approver` VARCHAR(64)  NULL COMMENT '审批人',
  `product_name` VARCHAR(64)  NULL COMMENT '产品名字',
  `cid` VARCHAR(32)  NULL COMMENT '分类id',
  `approve_time`DATE  NULL COMMENT '审批时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `subscribe_approve` (
  ...
  `update_date` DATE NOT NULL COMMENT '更新日期',
  `is_deleted` INT NOT NULL COMMENT '是否删除',
  `sub_code` VARCHAR(64)  NULL COMMENT '订阅单号',
  `product_id` VARCHAR(64)  NULL COMMENT '产品id',
  `approve_status` INT  NULL COMMENT '审批状态',
  `approver` VARCHAR(64)  NULL COMMENT '审批人',
  `product_name` VARCHAR(100)  NULL COMMENT '产品名字',
  `cid` VARCHAR(32)  NULL COMMENT '分类id',
  `approve_time`DATE NULL COMMENT '审批时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `workflow_subscribe_approve` (
  ...
  `is_deleted` INT NOT NULL COMMENT '是否删除',
  `sub_code` VARCHAR(64)  NULL COMMENT '订阅单号',
  `node_approval_status` INT  NULL COMMENT '节点审批状态',
  `node_approver` VARCHAR(64)  NULL COMMENT '节点审批人',
  `cid` VARCHAR(32)  NULL COMMENT '分类id',
  `user_list` VARCHAR(64)  NULL COMMENT 'node节点审批人',
  `workflow_id` VARCHAR(64)  NULL COMMENT '审批流id',
  `node_id` VARCHAR(64)  NULL COMMENT '审批流节点',
  `approve_time`DATE  NULL COMMENT '审批时间'
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `workflow_publish_approve` (
  ...
  `update_date` DATE NOT NULL COMMENT '更新日期',
  `is_deleted` INT NOT NULL COMMENT '是否删除',
  `pub_code` VARCHAR(64)  NULL COMMENT '发布单号',
  `node_approve_status` INT  NULL COMMENT '节点审批状态',
  `node_approver` VARCHAR(64)  NULL COMMENT '节点审批人',
  `cid` VARCHAR(32)  NULL COMMENT '分类id',
  `user_list` VARCHAR(64)  NULL COMMENT 'node节点审批人',
  `workflow_id` VARCHAR(64)  NULL COMMENT '审批流id',
